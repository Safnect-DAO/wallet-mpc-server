...
@Component
public class UnisatApiService {

	static final Integer TIMEOUT = 5000;
	static final Integer POST_TIMEOUT = 60000;
	
	public ResponseModel executeGet(String endpoint, String key, String path, Map<String, Object> paramMap) {
		String result = HttpClientUtil.httpGet(endpoint + path, paramMap, getHeader(key), TIMEOUT);
		return toRm(result);
	}
